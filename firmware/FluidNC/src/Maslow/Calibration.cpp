...
/*
 * Always returns VERTICAL orientation.
 * The Maslow 4 is a vertical machine - orientation detection has been removed.
 * Returns true immediately so calibration can proceed.
 */
bool Calibration::detectOrientation() {
    orientation = VERTICAL;
    log_info("Orientation: VERTICAL");
    return true;
}