...
namespace Machine {
    ...
    // Maslow M4: the four belt motors are axes 0-3 (A=TL, B=TR, C=BL, D=BR),
    // followed by Z (router) and an unused X placeholder.  MaslowKinematics
    // transforms cartesian XYZ into these motor axes.
    ...
    void Axes::group(Configuration::HandlerBase& handler) {
        ...
        // assigned at the individual motor level.
