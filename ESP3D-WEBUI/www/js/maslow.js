...
const cfgDef = {
	...
	Scale_X: { name: "scaleX", type: "A", cmd: "Maslow_Scale_X", fnDisp: (v) => { const n = parseFloat(v); return isNaN(n) ? v : n.toFixed(3); } },
	Scale_Y: { name: "scaleY", type: "A", cmd: "Maslow_Scale_Y", fnDisp: (v) => { const n = parseFloat(v); return isNaN(n) ? v : n.toFixed(3); } },
