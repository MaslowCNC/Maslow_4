...
namespace Machine {
    ...
    void MachineConfig::groupM4Items(Configuration::HandlerBase& handler) {
        ...
        handler.item(M + "_calibration_grid_size", Maslow.calibration.calibrationGridSize, 3, 99);
        handler.item(M + "_calibration_grid_size_X", Maslow.calibration.calibrationGridSizeX, 0, 99);
        handler.item(M + "_calibration_grid_size_Y", Maslow.calibration.calibrationGridSizeY, 0, 99);
